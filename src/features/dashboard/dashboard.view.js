...
export function renderDashboardView() {
  ...
  container.innerHTML = `
    <div id="logout-confirmation-popup" class="hidden fixed inset-0 bg-black/60 items-center justify-center z-20">
      <div class="bg-white rounded-2xl shadow-xl p-8 max-w-sm text-center transform transition-all scale-95 opacity-0">
        ...
        <div class="flex justify-center space-x-4">
          <button id="cancel-logout-btn" class="flex-1 bg-gray-200 text-gray-800 font-bold py-3 rounded-lg hover:bg-gray-300 transition-all">
            Cancelar
          </button>
          <button id="confirm-logout-btn" class="flex-1 bg-red-600 text-white font-bold py-3 rounded-lg hover:bg-red-700 transition-all">
            Sair
          </button>
        </div>
      </div>
    ...
    <aside id="sidebar" class="bg-gray-800 text-white w-64 flex-shrink-0 flex flex-col transition-all duration-300 ease-in-out">
      <nav class="flex-grow p-4 space-y-2">
        <a href="#" data-view="home" class="nav-link flex items-center py-2.5 px-4 rounded-lg bg-green-600/50">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
          <span class="sidebar-text ml-4">Dashboard</span>
        </a>
        <a href="#" data-view="objects" class="nav-link flex items-center py-2.5 px-4 rounded-lg hover:bg-gray-700 transition-colors">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg> 
          <span class="ml-3">Objetos</span>
        </a>
        <a href="#" data-view="accounts" class="nav-link flex items-center py-2.5 px-4 rounded-lg hover:bg-gray-700 transition-colors">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <main id="dashboard-content" class="flex-1 p-8"></main>
    </div>
  `;
