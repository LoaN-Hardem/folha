...
export function renderDashboardView() {
  ...
  container.innerHTML = `
    ...
    <div id="sidebar-backdrop" class="hidden md:hidden fixed inset-0 bg-black/50 z-30"></div>
      ...
      <aside id="sidebar" class="bg-white w-64 flex-shrink-0 flex flex-col fixed inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition-all duration-300 ease-in-out z-40 border-r border-gray-200">
        ...
        <nav class="flex-grow p-4 space-y-2">
          <a href="#/dashboard" data-view="home" class="nav-link flex items-center py-2.5 px-4 rounded-lg text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors duration-200">
          ...
          <a href="#/dashboard/objetos" data-view="objetos" class="nav-link flex items-center py-2.5 px-4 rounded-lg text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors duration-200">
          ...
          <a href="#/dashboard/accounts" data-view="accounts" class="nav-link flex items-center py-2.5 px-4 rounded-lg text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors duration-200">
          ...
          <a href="#/dashboard/settings" data-view="settings" class="nav-link flex items-center py-2.5 px-4 rounded-lg text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors duration-200">
            ...
            <span class="sidebar-text ml-4 transition-all duration-200">Configurações</span>
          </a>
        </nav>
        
        <div class="p-4 border-t border-gray-100">
          <a href="#" id="logout-btn" class="flex items-center py-2.5 px-4 rounded-lg text-gray-600 hover:bg-red-50 hover:text-red-600 transition-colors">
      ...
      <div class="flex-1 flex flex-col h-screen overflow-hidden">
       <header class="h-16 bg-white shadow-sm flex items-center justify-between px-6 flex-shrink-0 sticky top-0 z-20">
          <button id="menu-toggle-btn" class="text-gray-600 hover:text-indigo-600 focus:outline-none md:hidden">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
          </button>
          
          <button id="menu-toggle-btn-desktop" class="hidden md:block text-gray-600 hover:text-indigo-600 focus:outline-none">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
          </button>
          ...
          <div class="relative flex items-center space-x-4">
            ...
            <div class="flex items-center">
              <span id="navbar-user-name" class="text-gray-700 font-semibold mr-3">Olá, Usuário</span>
              <img id="navbar-user-avatar" class="w-10 h-10 rounded-full" src="https://ui-avatars.com/api/?name=Usuario&background=10B981&color=fff" alt="Foto do Perfil">
            </div>

            <button id="settings-btn" class="text-gray-500 hover:text-indigo-600 p-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924-1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826 3.31 2.37-2.37.996.608 2.296.096 2.572-1.065z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
            </button>
            
            <div id="settings-dropdown" class="hidden absolute top-full right-0 mt-2 w-48 bg-white shadow-2xl z-30 rounded-b-xl">
              <a href="#" id="edit-profile-btn" class="block px-4 py-3 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600">Editar Perfil</a>
              <a href="#" class="block px-4 py-3 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600">Preferências</a>
              <hr class="border-gray-300">
              <a href="#" id="logout-btn-dropdown" class="block px-4 py-3 text-red-600 hover:bg-red-50 rounded-b-xl">Sair</a>
            </div>
          </div>
        </header>
